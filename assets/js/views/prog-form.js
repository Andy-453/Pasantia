...
+'<div style="margin-top:6px"><label style="font-size:10px;font-weight:700;color:#555;display:block;margin-bottom:3px">📍 Sedes</label><div style="display:flex;flex-wrap:wrap;gap:4px">'+ALL_SEDES.map(function(s){return '<label style="display:flex;align-items:center;gap:2px;font-size:9px;cursor:pointer;padding:2px 6px;border-radius:4px;background:'+((l.sedes||[]).indexOf(s)>-1?'#e6f2eb':'#f5f5f5')+'"><input type="checkbox" id="lse_'+esc(l.id)+'_'+s+'" '+((l.sedes||[]).indexOf(s)>-1?'checked':'')+' style="margin:0"> '+esc(s)+'</label>';}).join('')+'</div></div>'
+'</div>';
  }).join('');
...
+'<div style="margin-top:6px"><label style="font-size:10px;font-weight:700;color:#555;display:block;margin-bottom:3px">📍 Sedes</label><div style="display:flex;flex-wrap:wrap;gap:4px">'+ALL_SEDES.map(function(s){return '<label style="display:flex;align-items:center;gap:2px;font-size:9px;cursor:pointer;padding:2px 6px;border-radius:4px;background:'+((m.sedes||[]).indexOf(s)>-1?'#e6f2eb':'#f5f5f5')+'"><input type="checkbox" id="mse_'+esc(m.id)+'_'+s+'" '+((m.sedes||[]).indexOf(s)>-1?'checked':'')+' style="margin:0"> '+esc(s)+'</label>';}).join('')+'</div></div>'
+'</div>';
  }).join('');
